...
import club.someoneice.withcoffee.util.bean.FoodItems;
import club.someoneice.withcoffee.util.bean.ItemItems;
import club.someoneice.withcoffee.util.bean.M3FoodItems;
import club.someoneice.withcoffee.util.bean.Milk;
...
public class ItemList {
    ...
    public static void init() {
        ...
        FoodCollectionCore.addItemEffect(foodLegendCoffee, MagicItemType.dropRate, 5f, (short) 10);
        FoodCollectionCore.addItemEffect(foodLegendTea, MagicItemType.boss_attack, 5f, (short) 10);
    }
